...
export const SourceUnknownLogo: FC<{ size?: number }> = ({ size = 32 }) => {
    return (
      <svg fill="#4788C7" width={`${size}px`} height={`${size}px`} viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
export const SourceUnknown: FC<{ size?: number }> = ({ size }) => {
    return (
      <div className="flex flex-col items-center">
        <SourceUnknownLogo size={size} />
        <span className="text-armaqi-base text-xs">Unknown</span>
      </div>
    );
};

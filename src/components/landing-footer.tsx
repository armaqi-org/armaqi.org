  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-8 mb-12">
        <a
          href="https://www.facebook.com/armaqiorg/"
          target="_blank"
          rel="nofollow noopener"
          aria-label="facebook"
        >
          <svg role="presentation" width="70px" height="70px" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a
          href="https://instagram.com/arm.aqi"
          target="_blank"
          rel="nofollow noopener"
        ...
        <a
          href="mailto:armaqi.org@gmail.com?subject=armaqi.org"
          target="_blank"
          rel="nofollow"
          aria-label="E-mail"
        >
